...
// Checks validity of username, email and password
// Returns empty string if valid, otherwise return error message
...
// Given a date string, it is returned in the form HH:MM(A/P)M
...
// Converts date from word form to DD/MM/YYYY or MM/YYYY
