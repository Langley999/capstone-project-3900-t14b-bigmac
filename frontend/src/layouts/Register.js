...
const Register = ({ updateLogin, updateUserInfo }) => {
  ...
  return (
    <div>
      ...
      {showVerify ? <VerifyPopup setShowVerify={setShowVerify} username={username} email={email} password={pass} setErrorMsg={setErrorMsg} setSnackBarOpen={setSnackBarOpen} /> : <></>}
    </div>
  );
};
export default Register;