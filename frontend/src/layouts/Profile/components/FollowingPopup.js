...
/**
 * Popup that appears when following list button is clicked in user profile
 * @param {Object} followers list of objects containing following information 
 * @returns a list of following's avatar and username links
 */
