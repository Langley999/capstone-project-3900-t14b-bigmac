...
export const ProfileAvatar = ({userInfo, updateUserInfo}) => {
  ...
  return (
    <div>
      ...
      {showFollowers ? <FollowerPopup followers={followers} setShowFollowers={setShowFollowers}/> : <></>}
      {showFollowings ? <FollowingPopup followings={followings} setShowFollowings={setShowFollowings}/> : <></>}
    </div>
  )
}